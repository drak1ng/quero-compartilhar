...
$$(document).on('page:init', function (e) {
    ...
    if(e.detail.el.dataset.page=="quem-somos"){
        $.get("http://novo.querocompartilhar.com.br/app_api/quem-somos.php", function(data){
            $("#quem-somos-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="servicos"){
        $.get("http://novo.querocompartilhar.com.br/app_api/servicos.php", function(data){
            $("#servicos-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="como-funciona"){
        $.get("http://novo.querocompartilhar.com.br/app_api/como-funciona.php", function(data){
            $("#como-funciona-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="duvidas"){
        $.get("http://novo.querocompartilhar.com.br/app_api/duvidas.php", function(data){
            $("#duvidas-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="contato"){
        $.get("http://novo.querocompartilhar.com.br/app_api/contato.php", function(data){
            $("#contato-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="politica-de-privacidade"){
        $.get("http://novo.querocompartilhar.com.br/app_api/politica-de-privacidade.php", function(data){
            $("#politica-de-privacidade-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="politica-de-cookies"){
        $.get("http://novo.querocompartilhar.com.br/app_api/politica-de-cookies.php", function(data){
            $("#politica-de-cookies-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="termos-de-uso"){
        $.get("http://novo.querocompartilhar.com.br/app_api/termos-de-uso.php", function(data){
            $("#termos-de-uso-content").html(data);
        });
    }

    if(e.detail.el.dataset.page=="oque-e-compartilhamento"){
        $.get("http://novo.querocompartilhar.com.br/app_api/oque-e-compartilhamento.php", function(data){
